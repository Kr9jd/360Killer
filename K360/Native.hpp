...
//copy from https://github.com/SafeBreach-Labs/PoolParty/blob/main/PoolParty/Native.hpp
...
typedef NTSTATUS(*FN_NtQueryObject)(
    HANDLE Handle,
...
typedef void (*FN_ZwAssociateWaitCompletionPacket)(
